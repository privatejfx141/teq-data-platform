...
public class TestPresetQuery {
    ...
    static int createAndInsertClient() {
        ...
        Client client = clientBuilder.setId(clientIdSt) //
                .setIdType(1) //
                .setBirthDate(ExcelDriver.fixDate("1965-09-13", "yyyy-MM-dd")) //
    ...
    static int createAndInsertClient(String birthDate) {
        IAddressBuilder addressBuilder = new AddressBuilder();
        Address address = addressBuilder.setPostalCode("M1G3L2") //
                .setUnitNumber(Integer.parseInt("1606")) //
                .setStreetNumber(Integer.parseInt("3050")) //
    ...
    static void createAndInsertManyClients() {
    ...
    static int createAndInsertService() {
        // insert client to db with address
        ...
        CommunityConnections communityConnections = (CommunityConnections) communityConnectionsBuilder
                .setEventType("Neighbourhood day") //
                .setMainTopic("Access to local community services") //
                .setServiceReceived("One-on-one orientation") //
                .setParticipants("10 - 20 people") //
                .setVolunteers(true) //
                .setReasonForLeave("Found employment") //
                .setStatus("Ongoing") //
                .setStartDate("2017-11-11") //
                .setEndDate("2018-03-12") //
                .setProjectedEndDate("2018-02-12") //
                .setLengthHours(23) //
                .setLengthMinutes(32) //
                .setClientId(clientId) //
                .setPostalCode("M1C 1A4") //
                .setLanguage("ENG") //
                .setOrganizationType("Public library") //
                .setReferredBy("Employer / co-worker") //
                .setUpdateReason("Amend record") //
                .setServiceType("Public library") //
                .setEssentialSkills(tempList) //
                .setSupportServices(tempList) //
                .setTargetGroups(tempList) //
                .setChildCares(tempList2) //
                .create();
    ...
    static int createAndInsertService(String birthDate) {
        // insert client to db with address
        int clientId = createAndInsertClient(birthDate);
        ...
        CommunityConnections communityConnections = (CommunityConnections) communityConnectionsBuilder
                ...
                .setReasonForLeave("Found employment") //
                .setStatus("Ongoing") //
                .setStartDate("2017-11-11").setEndDate("2018-03-12") //
                .setProjectedEndDate("2018-02-12") //
                .setLengthHours(23) //
                .setLengthMinutes(32) //
                .setClientId(clientId) //
                ...
                .setReferredBy("Employer / co-worker") //
                .setUpdateReason("Amend record") //
                .setServiceType("Public library").setEssentialSkills(tempList) //
                .setSupportServices(tempList) //
                .setTargetGroups(tempList) //
                .setChildCares(tempList2) //
                .create();
    ...
    static int createAndInsertService(String startDate, String endDate) {
        // insert client to db with address
        int clientId = createAndInsertClient();
    ...
    void testClientCount() throws SQLException {
        cleanDb();
        int serviceId = createAndInsertService();
    ...
    void testListOfStartDates() throws SQLException {
        ...
        createAndInsertClient();
        // create service object with test values for start and end date
        createAndInsertService("1980-03-27", "2017-05-24");
    ...
    void testNumberOfUsersWithinDate() throws SQLException, ParseException {
        ...
        createAndInsertClient();
        // create service object with test values for start and end date
        createAndInsertService("1980-03-27", "2017-05-19"); // within range
        createAndInsertService("2014-04-15", "2018-07-28"); // within range
        createAndInsertService("2012-04-15", "2013-03-12"); // not in range
        createAndInsertService("2019-04-15", "2020-02-05"); // not in range
    ...
    void testGetClientIDsforService() throws SQLException, ParseException {
        ...
        createAndInsertService("1985-03-12"); // 33
        createAndInsertService("1983-04-16"); // 35
        createAndInsertService("2015-03-22"); // 3
